...
# article_detail.py
# Part 2 / 4
# Hero section, metadata strip, intelligence cards
# ============================================================
...
# article_detail.py
# Part 3 / 4
# Entity sentiment heatmap, entity cards, analysis tabs
# ============================================================
...
with political_col:
    ...
    if orientation_row is not None or salience_row is not None:

        st.markdown("### Political Intelligence")

        political_cols = st.columns(2)


        with political_cols[0]:
        ...
        with political_cols[1]:

            st.markdown("**Salience**")

            st.write(
                salience_row["salience"]
